...
from models.network_dgsmp import DGSMP as net
...
def main():
    ...
    parser.add_argument('--training_patch_size', type=int, default=256, help='patch size used in training SwinIR. '
                                       'Just used to differentiate two different settings in Table 2 of the paper. '
                                       'Images are NOT tested patch by patch.')
    parser.add_argument('--large_model', action='store_true', help='use large model, only provided for real image sr')
    parser.add_argument('--model_path', type=str,
                        default='/home/huangtao/Code/Spectral_SCI/SR/superresolution/dgsmp_sr_classical_D&F_patch256_x4/models/635000_G.pth')
    parser.add_argument('--folder_lq', type=str, default='/home/huangtao/Data/SR/benchmark/Set5/LR_bicubic/X4', help='input low-quality test image folder')
    parser.add_argument('--folder_gt', type=str, default='/home/huangtao/Data/SR/benchmark/Set5/HR/X4', help='input ground-truth test image folder')
    ...
    for idx, path in enumerate(sorted(glob.glob(os.path.join(folder, '*')))):
        ...
        with torch.no_grad():
            ...
            # W = W[..., :h_old * args.scale, :w_old * args.scale]
            # U = U[..., :h_old * args.scale, :w_old * args.scale]
            #
            # W = W.cpu().permute(2, 3, 1, 0).squeeze(3).numpy()
            # save_path = '/home/huangtao/Code/Spectral_SCI/Transformer/Results_TPAMI_SR/W/X2/Set5/' + imgname + '.mat'
            # sio.savemat(save_path, {'W': W})
            #
            # U = U.cpu().permute(2, 3, 1, 0).squeeze(3).numpy()
            # save_path = '/home/huangtao/Code/Spectral_SCI/Transformer/Results_TPAMI_SR/U/X2/Set5/' + imgname + '.mat'
            # sio.savemat(save_path, {'U': U})
        ...
        cv2.imwrite(f'{save_dir}/{imgname}_DGSMP.png', output)
...
def define_model(args):
    ...
    if args.task == 'classical_sr':
        model = net(upscale=args.scale, in_chans=3, img_size=args.training_patch_size, window_size=8,
                    img_range=1., depths=[6, 6, 6, 6, 6], embed_dim=64, num_heads=[4, 4, 4, 4, 4],
                    mlp_ratio=4, resi_connection='1conv')
        param_key_g = 'params'
...
def setup(args):
    ...
    if args.task in ['classical_sr', 'lightweight_sr']:
        save_dir = f'/home/huangtao/Code/Spectral_SCI/SR/Results/X4/Set5/dgsmp_{args.task}_x{args.scale}'
    ...
    # 003 real-world image sr
        ...
        save_dir = f'results/dgsmp_{args.task}_x{args.scale}'
        if args.large_model:
            save_dir += '_large'
    ...
    # 004 grayscale image denoising/ 005 color image denoising
        ...
        save_dir = f'results/dgsmp_{args.task}_noise{args.noise}'
        folder = args.folder_gt
        border = 0
        window_size = 8
    ...
    # 006 JPEG compression artifact reduction
        ...
        save_dir = f'results/dgsmp_{args.task}_jpeg{args.jpeg}'
        folder = args.folder_gt
        border = 0
        window_size = 7
